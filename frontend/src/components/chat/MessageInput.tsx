...
// A simple paperclip icon for the image upload button
...
// A simple paper airplane icon for the send button
...
const MessageInput = () => {
  ...
  const handleSend = () => {
    if (inputValue.trim()) {
      console.log('Sending message:', inputValue); // Placeholder action
      setInputValue('');
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 p-3 md:p-4 rounded-md shadow-md mt-auto">
      <div className="flex items-end space-x-2 md:space-x-3">
        ...
        <textarea
          ...
          placeholder="Type your message to Chandler..." // Will be dynamic later
          ...
          rows={1}
          style={{ overflowY: 'hidden' }} // Hide scrollbar initially, show if content overflows
        />
        <button
          type="button"
          onClick={handleSend}
